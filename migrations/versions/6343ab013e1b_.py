...
Revision ID: 6343ab013e1b
Revises: 
Create Date: 2020-12-25 19:58:04.136352
...
def upgrade():
    ...
    sa.Column('rated_by_dj', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.Column('rated_by_client', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    ...
    sa.Column('dur_min', sa.String(length=100), nullable=True),
    sa.Column('dur_max', sa.String(length=100), nullable=True),
    sa.Column('viajes', sa.String(length=100), nullable=True),
    sa.Column('staff', sa.Integer(), nullable=True),
    sa.Column('arrienda_equipos', sa.String(length=100), nullable=True),
    ...
    sa.Column('time_created', sa.DateTime(), nullable=False),
    sa.Column('feedback_client', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.Column('feedback_dj', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.ForeignKeyConstraint(['client_id'], ['account.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['dj_id'], ['account.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
